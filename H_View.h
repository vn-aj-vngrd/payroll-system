        ...
        switch (temp) {
            ...
            case 2:  // C2
            {
                ...
                if (sa.attendanceID == -1) {
                    ...
                    if (insertAttendance(D, sa)) {
                        printf(
                            " \n Employee monthly attendance successfully "
                            "created.\n");
                    } else {
                        printf(
                            " \n ERROR: Employee monthly attendance already "
                            "exists.\n");
                    }
                }
                printf(
            ...
            case 3:  // C3
            {
                ...
                if (insertBonus(D, empBonus)) {
                    ...
                    printf(
                        "\n ERROR: Employee monthly bonus already exists.\n");
                }
                ...
                while (In2) {
                    ...
                    switch (temp) {
                        ...
                        case 3:  // C53
                        {
                            ...
                            Model_Attendance *empAttInfo =
                                searchAttendance(*D, empID, period);
                            if (empAttInfo == NULL) {
                                printf(
                                    "\n ERROR: Employee #%d attendance for "
                                    "period %s does not exist.\n",
                                    empID, period);
                                In9 = false;
                            }
                        ...
                        case 4:  // C54
                        {
                            ...
                            if (deleteAttendance(D, empID, period)) {
                                printf(
                                    "\n Employee attendance successfully "
                                    "deleted.\n");
                            } else {
                                printf(
                                    "\n ERROR: Employee attendance not "
                                    "found.\n");
                            }
                        ...
                        case 8:  // C58
                        {
                            ...
                            header();
                            printf(
                                " Employee Attendance > Set Overtime "
                                "Hours\n\n");
                        ...
                        case 3:  // C63
                        {
                            ...
                            while (In6) {
                                ...
                                switch (temp) {
                                    ...
                                    {
                                        printf(
                                            " Enter new user type [EMPLOYEE(0) "
                                            "/ EMPLOYER(1)]: ");
            ...
            // TODO: View/Update Employee Job Information -- Incomplete
            case 7:  // C7
            {
                while (In4) {
                    system("cls");
                    ...
                    switch (temp) {
                        ...
                        case 2:  // C72
                        {
                            ...
                            Model_JobInformation *jobInfo =
                                searchJobInformation(*D, empID);
                            if (jobInfo == NULL) {
                                printf(
                                    "\n ERROR: Employee #%d job information "
                                    "does not exist.\n",
                                    empID);
                                printf(
                                    " _________________________________________"
